...
public class quanliperson extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\anhph\\Pictures\\Add-icon.png")); // NOI18N
    ...
    private void tb1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tb1MouseClicked
        ...
        if (row >= 0) {
            ...
            txtgioitinh.setText(tb1.getValueAt(row, 3).toString());
...
//        dk.show();  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtgioitinh.getText().isEmpty()) {
            MessageDialogHelper.showErrorDialog(this, "Lỗi", "Vui lòng điền giới tính");
        ...
        try {
            ...
            a.setGioitinh(txtgioitinh.getText());
